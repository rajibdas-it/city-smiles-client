  ...
  return (
    <div>
      <div className="mb-12 flex justify-center items-center h-40 bg-gradient-to-tr from-blue-400 to-pink-400">
        <p className="text-4xl font-bold text-white text-center capitalize italic">
        ...
        <div className="mt-10">
          ...
          >
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
              ...
              <p className="text-base text-gray-700 md:text-lg text-justify">
                ...
                these databases the preferred choice for large or ever-changing
                data sets.
                <br />
          ...
          >
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
              ...
              <p className="text-base text-gray-700 md:text-lg text-justify">
                ...
                trusted because it is digitally signed. JWTs can be signed using
                ...
                based stateless session, server doesn't have to completely rely
                on a datastore(database) to save session information. <br />A
                JSON Web Token consists of 3 parts separated by a period. <br />
                ...
                <span className="font-bold">2. Payload:</span>Payload consists
                of the session data called as claims. Below are some of the the
                standard claims that we can use, Issuer(iss), Subject (sub),
                Audience (aud), Expiration time (exp), Issued at (iat). <br />
                <span className="font-bold">3. Signature:</span>Signature is
                most important part of a JSON Web Token(JWT). Signature is
                calculated by encoding the header and payload using Base64url
                Encoding and concatenating them with a period separator. Which
                is then given to the cryptographic algorithm. So when the header
                or payload changes, signature has to calculated again. <br />
          ...
          >
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
              ...
              <p className="text-base text-gray-700 md:text-lg text-justify">
                <span className="text-2xl font-bold italic">JavaScript </span>{" "}
                is a Scripting language. It is mostly abbreviated as JS. It can
                be said that Javascript is the updated version of the ECMA
                script. Javascript is a high-level programming language that
                uses the concept of Oops but it is based on prototype
                inheritance. <br />
                ...
                <br />
                5. It is the upgraded version of ECMA script that uses Chrome’s
              ...
              <p className="text-base text-gray-700 md:text-lg text-justify">
                ...
                is a cross-platform and open source Javascript runtime
          ...
          >
            <div className="max-w-xl mb-5 md:mx-auto sm:text-center lg:max-w-2xl">
              ...
              <p className="text-base text-gray-700 md:text-lg text-justify">
                ...
                NodeJS receives these requests and places them into the
                EventQueue . NodeJS server has an internal component referred to
                as the EventLoop which is an infinite loop that receives
                requests and processes them. This EventLoop is single threaded.
                we can have multiple connections from the same client to the
                same server. Each client process will be assigned a different
                ephemeral port number, so even if they all try to access the
                same server process (such as the Web server process at 41.199.
                It’s partly due to the fact a multi-threaded program can run on
                multiple cores but the main reason, by far, is that when a
                thread is waiting for some IO operation (which is very often,
                especially in a server), the other threads can still progress.
                As Node. js follows Single-Threaded with Event Loop Model
                inspired by JavaScript Event-based model with JavaScript
                callback mechanism. js is single-threaded similar to JavaScript
                but not purely JavaScript code which implies things that are
                done asynchronously like network calls, file system tasks, DNS
                lookup, etc. A single instance of a Node. js application runs on
                only one thread and, therefore, doesn’t take full advantage of
                multi-core systems. There will be times when you may want to
                launch a cluster of Node. js processes to utilize each CPU core
                on a local machine or production server. Node Js use threads but
                in a smart way. It uses single thread to serve all the HTTP
                requests & multiple threads in thread pool (in libuv) for
